...
class Cancion(db.Model):
    ...
    def __repr__(self):
        #return f'Cancion({self.titulo}, {self.minutos}, {self.segundos}, {self.interprete})'
...
class Album(db.Model):
    ...
    #restriccion titulo unico (tupla)
    ...
    def __repr__(self):
        return f'Album({self.titulo}, {self.anio}, {self.descripcion}, {self.medio})'
...
class Usuario(db.Model):
    ...
    def __repr__(self):
        return f'Usuario({self.nombre}, {self.contrasena})'
